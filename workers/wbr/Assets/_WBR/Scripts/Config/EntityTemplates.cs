...
public static class EntityTemplates
{
    public static EntityTemplate CreatePlayerEntityTemplate(EntityId entityId, string workerId, byte[] serializedArguments)
    {
        ...
        var clientRadius = 500; //workerId.Contains(MobileClientWorkerConnector.WorkerType) ? 100 : 500;
        ...
        template.SetReadAccess(UnityClientConnector.WorkerType, serverAttribute); // , MobileClientWorkerConnector.WorkerType, serverAttribute);
